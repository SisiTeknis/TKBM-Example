...
import 'package:big_koperasi/features/loan/presentation/widgets/loan_bottom.dart';
...
class DetailLoanScreen extends StatefulWidget {
  //final Product product;
  const DetailLoanScreen({super.key});

  @override
  State<DetailLoanScreen> createState() => _DetailLoanScreenState();
}

class _DetailLoanScreenState extends State<DetailLoanScreen> {
  bool isLoading = true;
  int count = 1;
  String plus = "PLUS";
  String minus = "MINUS";
